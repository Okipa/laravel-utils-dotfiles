...
echo "${purple}→ rsync -Prz --info=progress2 ${productionProjectPath}/shared/public/files/ ${productionDumpStorageDirectory}/files${reset}"
rsync -Prz --info=progress2 ${productionProjectPath}/shared/public/files/ ${productionDumpStorageDirectory}/files
