...
echo "${purple}→ cp -R ${currentProductionProjectPath}/shared/public/files ${currentPreprodProjectPath}/shared/public/files${reset}"
cp -R ${currentProductionProjectPath}/shared/public/files ${currentPreprodProjectPath}/shared/public/files
