...
#echo "${purple}→ cp -R ${productionProjectPath}/shared/public/files ${preprodProjectPath}/shared/public/files${reset}"
#cp -R ${productionProjectPath}/shared/public/files ${preprodProjectPath}/shared/public/files
#echo "${purple}→ chown -R ${preprodUser}:users ${preprodProjectPath}/shared/public/files${reset}"
#chown -R preprod:users ${preprodProjectPath}/shared/public/files
